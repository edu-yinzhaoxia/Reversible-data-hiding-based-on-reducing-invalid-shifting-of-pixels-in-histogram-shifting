function [ pre_I,err_I,num_0,num_1,num_11,Z1,Z2,PK1,PK2 ] = predictionB( I )
...
%画出预测误差直方图
err1=[err_I(2:+2:m-1,3:+2:n-1);err_I(3:+2:m-1,2:+2:n-1)];%取出菱形mod（i+j,2）==0的值
hist_error_I=tabulate(err1(:));%对预测误差各个像素值进行统计
[PK1,PK2,Z1,num]=findpz1(err1); %PK1为峰值点，PK2为次峰值点
